...
import { Proficient, Familiar } from '../assets/SkillData'
const Skill = () => {
  return (
    <div id="Skill">
        ...
        <div className='pl-3'>
          ...
          <div className='my-7 grid gap-5 grid-cols-3 md:grid-cols-6 content-center'>
            {Proficient.map((x, index) =>
              <div className='flex flex-col items-center hover:scale-125 transition duration-500' tabIndex='0' role='img' aria-label={x.skill} key={index}>
